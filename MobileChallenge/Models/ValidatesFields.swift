...
class ValidatesFieldsAddFields: UIView {
    ...
    func thisField(field: String, type: InputType) -> Bool {
        ...
        case .shipping:
            ...
            if shipping_Validated.isInt && shipping_Validated.count > 1 && Double(shipping_Validated)! != 0 { result = true } else { result = false }
        ...
        case .discount:
            ...
            if discount_Validated.isInt && discount_Validated.count > 1 && (Double(discount_Validated)!/100 < 100) && Double(discount_Validated)! != 0 { result = true } else { result = false }
        ...
        case .conditional_discount:
            ...
            if conditional_discount_Validated.isInt && conditional_discount_Validated.count > 1 && (Double(conditional_discount_Validated)!/100 < 100) && Double(conditional_discount_Validated)! != 0 { result = true } else { result = false }
        case .until_date:
            if field != "" { result = true } else { result = false}
        case .message:
